...
set rt::rc [catch {
  uplevel #0 {
    ...
    set ::env(RT_TMP) "C:/Awork/y3s1/HWSynLab/project/project_faro/project_faro.runs/synth_1/.Xil/Vivado-2976-Jeans/realtime/tmp"
    ...
    set rt::SDCFileList C:/Awork/y3s1/HWSynLab/project/project_faro/project_faro.runs/synth_1/.Xil/Vivado-2976-Jeans/realtime/top_synth.xdc
    rt::sdcChecksum
    set rt::top top
...
# MODE: 
    ...
    rt::set_parameter enableSplitFlowPath "C:/Awork/y3s1/HWSynLab/project/project_faro/project_faro.runs/synth_1/.Xil/Vivado-2976-Jeans/"
