...
set rt::rc [catch {
  uplevel #0 {
    ...
    set ::env(RT_TMP) "C:/Awork/y3s1/HWSynLab/project/project_faro/project_faro.runs/synth_1/.Xil/Vivado-11448-Jeans/realtime/tmp"
    ...
    if {$rt::useElabCache == false} {
      rt::read_verilog -include C:/Awork/y3s1/HWSynLab/project/project_faro/project_faro.srcs/sources_1/new {
    ...
    set rt::SDCFileList C:/Awork/y3s1/HWSynLab/project/project_faro/project_faro.runs/synth_1/.Xil/Vivado-11448-Jeans/realtime/top_synth.xdc
    rt::sdcChecksum
    set rt::top top
...
# MODE: 
    rt::set_parameter webTalkPath {C:/Awork/y3s1/HWSynLab/project/project_faro/project_faro.cache/wt}
    rt::set_parameter synthDebugLog false
    rt::set_parameter printModuleName false
    rt::set_parameter enableSplitFlowPath "C:/Awork/y3s1/HWSynLab/project/project_faro/project_faro.runs/synth_1/.Xil/Vivado-11448-Jeans/"
