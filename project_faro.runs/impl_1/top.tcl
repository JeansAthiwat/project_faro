namespace eval ::optrace {
  variable script "C:/Awork/y3s1/HWSynLab/project/project_faro/project_faro.runs/impl_1/top.tcl"
...
OPTRACE "add files" START { }
  add_files -quiet C:/Awork/y3s1/HWSynLab/project/project_faro/project_faro.runs/synth_1/top.dcp
